...
#ifndef _H_RaggedFloatTable_Edit
#define _H_RaggedFloatTable_Edit
...
"|* %i Copy::JX"
"|* %i Paste::JX"
"|* %i PasteAtSelection::RaggedFloatTable %l"
"|* %i Insert::RaggedFloatTable"
"|* %i Duplicate::RaggedFloatTable"
"|* %i Delete::RaggedFloatTable"
;

#include "RaggedFloatTable-Edit-enum.h"
...
static void ConfigureEditMenu(JXTextMenu* menu, const int offset = 0) {
	...
	menu->SetItemImage(kDeleteCmd + offset, jx_edit_clear);
};
